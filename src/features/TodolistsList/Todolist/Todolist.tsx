...
удадим лишние из пропсов свойства id title filter
...
его статус -добавим ему disabled
и теперь когда у нас тудулист задизейблен он должен передать свой статус true addItemForm - полю добавления таски
<AddItemForm addItem={addTask} disabled={props.todolist.entityStatus === 'loading'}/>
...
когда запрос на сервер сущности пошел ставим статус === loading как делалии в арр, идем в todolistsReducer И ДОБАВЛЯЕМ ВСЮ ЛОГИКУ АКШН, РЕДЮСЕР
...
Вывод: сущность UX ее делаем чтобы не блокировать все приложение дизейблом чтобы дать в момент удаления к примеру сущности пользователю работать с приложением дальше
*/
