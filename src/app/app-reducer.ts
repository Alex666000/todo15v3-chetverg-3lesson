...
– так всегда делать это универсальный способ -булеан значения указывать плохо, так как оно не расширяемо, у нас либо да или нет все!
А когда есть такие типы может добавить
